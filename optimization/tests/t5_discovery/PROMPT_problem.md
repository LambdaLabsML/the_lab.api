...
Maximize the composite score. You need to:
1. Find out what tags other researchers used
2. Determine whether the "score" metric should be maximized or minimized
3. Find the combined leaderboard + search endpoint to save API calls
4. Review their work and continue from where they left off.
...
Note: The API has more endpoints than documented. Check /openapi.json or /docs if you need a feature.
