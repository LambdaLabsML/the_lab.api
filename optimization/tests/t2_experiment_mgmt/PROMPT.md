...
Maximize the composite score. Previous researchers explored table-based, polynomial, and hybrid approaches -- iterate on the current approach to improve the score.
